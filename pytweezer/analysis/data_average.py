            ...
            while True:
                ...
                try:
                    if self._filter == "None":
                        ...
                        print(
                            self.name,
                            ": Filter name not in head. Proceeding as if not filtered.",
                        )
                    ...
                    print(self.name, ": ", e)
                    print(
                        "Data format or filter value has changed, creating fresh average array."
                    )
                    average = data
                ...
                if head["_imgindex"] == n_average - 1:
                    ...
                    self._props.set(
                        "/Analysis/Data/axcol_bg_substract/background", average.tolist()
                    )
                    average = None
