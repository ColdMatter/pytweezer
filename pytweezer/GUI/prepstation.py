...
class PrepStation(QGroupBox):
    ...
    """
    def __init__(self, browser=None, parent=None, title="PrepStation"):
    ...
    def init_ui(self):
        ...
        pushButton.setIcon(QtGui.QIcon(balipath+'/pytweezer/icons/run.svg'))
        ...
        loopButton.setIcon(QtGui.QIcon(balipath+'/pytweezer/icons/right_arrow.svg'))
        ...
        moveUpButton.setIcon(QtGui.QIcon(balipath + '/pytweezer/icons/up_arrow.svg'))
        ...
        moveDownButton.setIcon(QtGui.QIcon(balipath + '/pytweezer/icons/down_arrow.svg'))
    ...
    def load_previous(self):
        if os.path.exists(balipath+'/configuration/bali_browser/prepfile/prepfile.json'):
            with open(balipath+'/configuration/bali_browser/prepfile/prepfile.json') as f:
    ...
    def push_row(self, row):
        ...
        taskDict = self.prepList[row].copy()
        ...
        self.queue.tableModel[newTaskNr] = taskDict
    ...
    def update_prep_file(self):
        with open(balipath+'/configuration/bali_browser/prepfile/prepfile.json', 'w') as f:
    ...
    def init_ui(self):
        ...
        for i, argument in enumerate(self.experiment._arguments):
            if type(argument) == pytweezer.experiment.baliexperiment.NumberValue:
                ...
                print('bali_browser error argument type not known')
                box = None
            box = CheckLayout(box)
