...
class ExperimentQ(QGroupBox):
    ...
    def create_buttons(self):
        ...
        self.pauseButton.setIcon(QtGui.QIcon(balipath+'/pytweezer/icons/pause.png'))
        self.pauseButton.clicked.connect(self.pause)
        self.buttonLayout.addWidget(self.pauseButton)

        terminateButton = QPushButton('')
        terminateButton.setMaximumWidth(30)
        terminateButton.setIcon(QtGui.QIcon(balipath+'/pytweezer/icons/terminate.png'))
        ...
        terminateAllButton.setIcon(QtGui.QIcon(balipath + '/pytweezer/icons/nuke_icon.png'))
    ...
    def pause(self):
        ...
        if self.browser.expManager.paused:
            self.pauseButton.setIcon(QtGui.QIcon(balipath+'/pytweezer/icons/run.png'))
        else:
            self.pauseButton.setIcon(QtGui.QIcon(balipath+'/pytweezer/icons/pause.png'))
